...
<div class="slider-area">
    <div class="homepage-slider">
        <div class="single-slider content-v-center" style="background-image: url({{ asset('user/img/slider/slider1-mirora1-1920x634.jpg') }})">
            <div class="container">
                <div class="row">
                    <div class="col-12">
        ...
        <div class="single-slider content-v-center" style="background-image: url({{ asset('user/img/slider/slider2-mirora1-1920x634.jpg') }})">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="slider-content">
                    ...
                    <div class="col-12">
                        <div class="slider-content">
                            ...
                            <h1 data-animation="fadeInDown" data-duration=".8s" data-delay=".3s">H-Vault
                                Classico</h1>
                            <p class="mb--30 mb-sm--20" data-animation="fadeInDown" data-duration=".8s" data-delay=".3s">H-Vault Watches Are A Lot Like Classic American Muscle Cars
                            ...
                            <div class="slide-btn-group" data-animation="fadeInUp" data-duration="1s" data-delay=".3s"><a href="" class="btn btn-bordered btn-style-1">Shop Now</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <ul class="nav nav-tabs product-tab__head" id="product-tab" role="tablist">
                    <li class="product-tab__item nav-item active"><a class="product-tab__link nav-link active" id="nav-featured-tab" data-toggle="tab" href="#nav-featured" role="tab" aria-selected="true">Hàng mới về</a></li>
                    <li class="product-tab__item nav-item"><a class="product-tab__link nav-link" id="nav-new-tab" data-toggle="tab" href="#nav-new" role="tab" aria-selected="false">Khuyến mãi</a></li>
                    <li class="product-tab__item nav-item"><a class="product-tab__link nav-link" id="nav-bestseller-tab" data-toggle="tab" href="#nav-bestseller" role="tab" aria-selected="false">Bán chạy</a></li>
                </ul>
...
<section class="blog-area pt--80 pb--40 pt-md--60 pb-md--30">
    <div class="container">
        ...
        <div class="row mt--35 mt-md--25">
            <div class="col-12 text-center"><a href="instagram.com" class="btn btn-medium btn-style-2"><i class="fa fa-instagram"></i>Instagram</a></div>
        </div>
    </div>
</section>
